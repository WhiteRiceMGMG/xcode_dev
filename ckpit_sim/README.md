...
公開IF  公開関数             備考
---------------------------------------------
        vdg_pwrtrn_16msh()   16ms高優先度
        vdg_pwrtrn_50msm()   50ms中優先度
        vdg_pwrtrn_100msl()  100ms低優先度
----------------------------------------------
...
公開IF  公開関数             備考
---------------------------------------------
        vdg_prtct_16msh()    16ms高優先度
        vdg_prtct_50msm()    50ms中優先度
        vdg_prtct_100msl()   100ms低優先度
----------------------------------------------
...
公開IF  公開関数             備考
---------------------------------------------
        vdg_perm_16msh()     16ms高優先度
        vdg_perm_50msm()     50ms中優先度
        vdg_perm_100msl()    100ms低優先度
----------------------------------------------
...
公開IF  公開関数             備考
---------------------------------------------
        vdg_acelcrt_pwon()   初期化
        vdg_acelcrt_50msm()  50ms中優先度
----------------------------------------------
公開IF  公開変数             備考
---------------------------------------------
        u1_acelcrt_thlopn    補正後アクセル開度
        u1_acelcrt_crtflg    補正有無状態
----------------------------------------------
...
---------------------------------------------
        vdg_brkcrt_pwon()   初期化
        vdg_brkcrt_16msh()  16ms高優先度
----------------------------------------------
公開IF  公開変数             備考
---------------------------------------------
        u1_brkcrt_brkopn    補正後ブレーキ開度
        u1_brkcrt_crtflg    補正有無状態
----------------------------------------------
...
【クラッチ補正】clthcrt (pwrtrn)
  ...
  公開IF  公開関数             備考
---------------------------------------------
        vdg_clthcrt_pwon()   初期化
        vdg_clthcrt_50msm()  50ms中優先度
----------------------------------------------
公開IF  公開変数             備考
---------------------------------------------
        u1_clthcrt_trqrate   トルク伝達率
        u1_clthcrt_crtflg    補正有無状態
----------------------------------------------
...
【ギアシフト情報補正】gearcrt (pwrtrn)
  ...
  公開IF  公開関数             備考
---------------------------------------------
        vdg_gearcrt_pwon()   初期化
        vdg_gearcrt_50msm()  50ms中優先度
----------------------------------------------
公開IF  公開変数             備考
---------------------------------------------
        u1_gearcrt_sift   ノイズ除去済みギアシフト情報
        u1_clthcrt_crtflg    補正有無状態
----------------------------------------------
